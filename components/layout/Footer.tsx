...
export default function Footer() {
  return (
    <footer className="p-4 bg-white  shadow md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-800">
        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">Copyright © {new Date().getFullYear()} CRETA</span>
      <ul className="flex flex-wrap items-center mt-3 text-sm text-gray-500 dark:text-gray-400 sm:mt-0 mx-4">
        <li className="mx-2">
          <a href="https://www.twitter.com/" target="_blank" rel="noopener noreferrer">
            <svg
              className="text-gray-500 hover:text-green-400 fill-current cursor-pointer"
              width="21"
              height="20"
              href="www.twitter.com.br"
            >
              <title>Twitter</title>
