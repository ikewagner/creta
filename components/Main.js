        ...
        <main>
            <div class="relative px-6 lg:px-8">
                <div class="mx-auto max-w-3xl pt-20 pb-32 sm:pt-48 sm:pb-40">
                    <div>
                        <div>
                            <h1 class="text-4xl font-bold tracking-tight sm:text-center sm:text-6xl">Bem vindo à CRETA Arquitetura e Engenharia!</h1>
                            <p class="mt-6 text-lg leading-8 text-gray-600 sm:text-center">Uma empresa do ramo da construção civil que nasceu com o desejo ardente de fazer parte da sua história, de cuidar dos seus sonhos e o mais importante… torná-los REALIDADE.</p>
